...
public  static partial class Utilities{
 //NOTE THIS CLASS WASNT MADE BY ME!
...
private static uint joaat_lookup(string str, uint initialHash){
...
var hash = joaat_lookup(str, initialHash);
hash += (hash << 3);
hash ^= (hash >> 11);
hash += (hash << 15);
return hash;
...
/// <returns>A hash key compatible with GTA 5.</returns>
public static uint joaat(string str, uint initialHash)=> 
...
/// <returns>A hash key compatible with GTA 5.</returns>
public static uint joaat(string str, string concat)=> 
joaat(str, concat, 0);
...
/// <param name="initialHash">The initial hash key value used to generate the result.</param>
/// <returns>A hash key compatible with GTA 5.</returns>
public static uint joaat(string str, string concat, uint initialHash)=> 
GetHashKeyFinalize(concat, joaat(str, initialHash));
